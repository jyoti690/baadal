...
class Connection:
    ...
    def fetch_sample_data(self,vm_id,g_type,limits=None):
        ...
        print vm_id
        query = [dict(field='resource_id', op='eq', value=vm_id),dict(field='meter', op='eq', value=g_type),dict(field='timestamp',op='ge',value="2016-07-31T18:00:00"),dict(field='timestamp',op='le',value="2016-08-03T17:00:00"),dict(field='timestamp', op='eq', value='DESC')]
